...
data = pandas.read_csv("/home/k_mathin/PycharmProjects/DataMiningClass/datasets/classification/fulldataset_weed_images_classifciation.csv",
                       header=None,
                       skiprows=1)

X = data.iloc[:, 0:400]  # slicing: all rows and 1 to 4 cols
...
true_lables = np.sort(np.unique(y))  # [u'george', u'greg', u'kevin']
ind = np.searchsorted(true_lables, y)
y = ind
